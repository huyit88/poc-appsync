...
export function response(ctx) {
  ...
  // SQL query returns 13 columns: claim (8) + customer (5)
  // Columns: claim_id(0), customer_id(1), policy_id(2), claim_type(3), status(4), amount(5),
  //          submitted_at(6), updated_at(7), customer_customer_id(8), full_name(9), email(10), phone(11), customer_updated_at(12)
