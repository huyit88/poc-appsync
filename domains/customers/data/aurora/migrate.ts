/**
 * Aurora Migration Script
 * 
 * Creates the customers table schema in Aurora PostgreSQL.
 * 
 * Usage:
 *   tsx domains/customers/data/aurora/migrate.ts
 * 
...
async function migrate() {
  console.log('Starting Aurora migration...');
